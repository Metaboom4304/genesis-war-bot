...
function sendMainMenu(chatId, userId) {
  ...
  let message = `🧙‍♂️ Добро пожаловать, стратег!

Ты ступил на земли Genesis of Ages — где каждый тайл может стать оплотом империи или могилой для дерзких завоевателей.

Здесь нет места хаосу. Только чёткий план, верные союзники и карта, что знает всё:
— где враг укрепился,
— где ресурсы ждут своего часа,
— и где ты оставишь свой след.

Получи код доступа — и пусть твоя тактика станет легендой.!\n\n`;
